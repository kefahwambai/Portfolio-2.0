      ...
      <section className="insights-teaser section-pad">
        <Container>
          ...
          <div className="insight-preview-grid">
            <article><div className="article-meta">LAW &amp; TECHNOLOGY</div><h3>When technology moves faster than legal procedure</h3><p>A space for practical commentary on how new tools reshape evidence, process and professional responsibility.</p></article>
            <article><div className="article-meta">PRACTICE</div><h3>Procedure is strategy, not paperwork</h3><p>Short notes on procedural developments and what they mean in day-to-day legal practice.</p></article>
            <article><div className="article-meta">DIGITAL ECONOMY</div><h3>Regulation in an increasingly digital market</h3><p>Tracking the legal questions created by platforms, data, digital finance and changing business models.</p></article>
          </div>
        </Container>
      </section>
